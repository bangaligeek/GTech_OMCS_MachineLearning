...
trainer = BackpropTrainer(fnn_backprop, dataset=training_data, momentum=0.1, verbose=False, weightdecay=0.01)
...
ylim = (0, 40)
xlim = (50, 1005)
plot_learning_curve(epoch_v, trnerr_backprop, tsterr_backprop, "Neural Network With Backpropagation", "Epochs", "Error %", ylim, xlim=None)
